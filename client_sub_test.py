...
db_path = '/home/admin/databases/current_database2.db'
...
def insert_data(table_name, mic_reading):
    ...
    query = f"INSERT INTO {table_name} (hour, minute, second, day, month, year, mic_reading) VALUES (?, ?, ?, ?, ?, ?, ?)"
    data_tuple = (current_hour, current_minute, current_second, current_day, current_month, current_year, mic_reading)
    try:
        # Execute the query
